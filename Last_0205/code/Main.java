...
public class Main {
    ...
    private static String nomIA=null,nomPilote=null;
    ...
    public static void lancerRobot(Graphe graphe) {
    	new Thread(()-> {
    		new Pilote(nomPilote,posRobotPilotePrevious,posRobotPilote,graphe,deplacementInit,capaciteCofrre,nomIA,new Bluetooth(nomPilote,"001653161388"));
    	}).start();
    }
    ...
    public static void lancerIA(Graphe graphe) {
        new Thread(()-> {
            try {
                try {
					new Ia(nomIA,posRobotIAPrevious,posRobotIA,graphe,deplacementInitIA,capaciteCofrre,nomPilote,new Bluetooth(nomIA,"0016531C1995"));
				} catch (IOException e) {
