...
public class Simulation {
	...
	public void sent(String mess,int positionR, int previousPos, String lastdep,boolean pilote) {
		...
		System.out.println("pil = "+pilote);
		System.out.println("dans sent = "+mess);
		System.out.println("dans sent = "+indexR);
		if((positionR!=previousPos) && !(mess.contains("u")) && lastdeplacement!="u" && mess!="20t" && mess!="20d"&& positionR!=oldCurrent) {
			int y = coord.get(1);
			int y2 = coord2.get(1);
