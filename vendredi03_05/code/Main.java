...
public class Main {
    ...
    public static void lancerRobot(Graphe graphe) {
    	new Thread(()-> {
    		if (blue) {
                new Pilote(nomPilote,posRobotPilotePrevious,posRobotPilote,graphe,deplacementInit,capaciteCofrre,nomPilote,new Bluetooth(nomPilote,portPilote),sem);
            }else {
                new Pilote(nomPilote, posRobotPilotePrevious, posRobotPilote, graphe, deplacementInit, capaciteCofrre, nomPilote,null, sem);
            }
    	}).start();
    }
    ...
    public static void lancerIA(Graphe graphe) {
        if (blue) {
            new Ia(nomIA, posRobotIAPrevious, posRobotIA, graphe, deplacementInitIA, capaciteCofrre, nomPilote, new Bluetooth(nomIA, portIA), sem);
        }else {
            new Ia(nomIA, posRobotIAPrevious, posRobotIA, graphe, deplacementInitIA, capaciteCofrre, nomPilote,null, sem);
        }
