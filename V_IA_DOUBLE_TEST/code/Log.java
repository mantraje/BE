...
public class Log {
    ...
    public Log(Robot robot) {
        ...
        try {
            ...
            log.write(currentTime+"@"+monNxt+"@p="+robot.getPreviousPos()+"@"+robot.getCurrentPos()+"@"+"\n");
        } catch (IOException e) {
            e.printStackTrace();
        }
        try {
    ...
    public void ecrire(String message){
        ...
        try {
            currentTime = LocalDateTime.now();
            log.write(currentTime+"@"+monNxt+"@p="+robot.getPreviousPos()+"@"+robot.getCurrentPos()+"@"+message+"\n");
        } catch (IOException e) {
            e.printStackTrace();
        }
        try {
