...
public class Main {
    ...
    public static void lancerRobot(Graphe graphe) {
    	new Thread(()-> {
    		new Pilote(nomPilote,posRobotPilotePrevious,posRobotPilote,graphe,deplacementInit,capaciteCofrre,nomIA);
    	}).start();
    }
    ...
    public static void lancerIA(Graphe graphe) {
        new Thread(()-> {
            try {
                try {
					new Ia(nomIA,posRobotIAPrevious,posRobotIA,graphe,deplacementInitIA,capaciteCofrre,nomPilote);
				} catch (IOException e) {
