...
public class Ia extends Robot {
    ...
    private Interface simul = new Interface();
    ...
    public void lancerIA() throws InterruptedException, IOException {
        ...
        int but,currentPosHypo=currentPos,previousPosHypo=previousPos,nextFrist;
        ...
        boolean debut = (graphe.estIntersec(currentPosHypo)) && graphe.getVoisin(currentPos).contains((Integer) but);
        ...
        this.cheminResul = cheminResult;
        envoieChemin(cheminResult);
        simul.start(cheminResult);
    }
